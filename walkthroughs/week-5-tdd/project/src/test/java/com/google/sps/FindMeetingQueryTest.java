...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void attendeeAllDayConflict() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartDuration(0, TimeRange.WHOLE_DAY.duration() + 1),
  ...
  @Test
  public void roomForOptionalAttendee() {
  ...
  @Test
  public void onlyValidOptionalAttendees() {
  ...
  @Test
  public void onlyInvalidOptionalAttendees() {
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(0, 720),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(720, 1420),
            Arrays.asList(PERSON_B)));
